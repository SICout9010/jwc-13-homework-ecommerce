...
function Footer() {
  return (
    <main className="flex flex-col items-center relative">
      <div className="flex items-center justify-between p-8 px-20 bg-black w-[1240px] h-[180px] rounded-[20px] absolute top-[-18%] text-white">
        ...
        <div className="flex flex-col w-[349px] max-h-[105px] gap-3">
          <div className="flex items-center p-4 bg-white h-[48px] rounded-[62px] gap-3">
            ...
            <input
              className="text-[#00000066] outline-none"
              type="text"
              placeholder="Enter your email address"
            />
          </div>
          <div className="text-black flex items-center justify-center bg-white h-[48px] rounded-[62px] cursor-pointer">
      ...
      <footer className="w-full flex flex-col items-center justify-center bg-[#F0F0F0] min-h-[499px] gap-4">
        <div className="w-full flex  justify-between gap-1 mt-[100px] mb-8 max-w-[1230px]">
          <div className="flex-wrap content-between">
            <h1 className={`${dm_sans.className} text-4xl font-bold pb-[18px]`}>
              JWC.CO
            </h1>
            <p className="opacity-60 text-sm leading-6  pb-[34px]">
            ...
            <div className="flex gap-4">
              <svg width="148" height="28" viewBox="0 0 148 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="94" cy="14" r="13.5" stroke="black" strokeOpacity="0.2" />
        ...
        <div className="w-[1240px] h-0.5 bg-[#0000001A]"></div>

        <div className="min-w-[1280px] flex items-center justify-between">
          ...
          <Image
            ...
            width={300}
            height={300}
            className="self-end relative right-2"
          />
        </div>
      </footer>
    </main>
